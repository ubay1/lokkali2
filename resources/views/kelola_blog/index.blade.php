                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" class="form-control" id="judul" name="judul"
                                placeholder="Enter Teks Judul" value="" maxlength="50" required="">
                        </div>
                    </div>
            ...
            <div class="modal-body">
                ...
                <form id="userForm2" name="userForm2" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="judul2" name="judul2" placeholder="Enter Teks Judul"
                            required="">
                    </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#create-new-user').click(function () {
            ...
            $('#userCrudModal').html("Add New Blog");
        ...
        $('body').on('click', '.edit-user', function () {
            ...
            $.get('kelolaBlog/' + user_id + '/edit', function (data) {
                $('#userCrudeditModal').html("Edit Blog");
        ...
        $('body').on('click', '#delete-user', function () {
            ...
            $.ajax({
                type: "get",
                url: api+"admin/hapusdataBlog/" + user_id,
