<template>
    <div>
        <div class="case-header-background">
            <Menu />
        </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="bg-img-case-popular">
                            <img class="img-case-popular col-md-8" v-lazy="this.allcasepopuler.gambar" :key="this.allcasepopuler.gambar" alt="">
                            <div class="text-head-case col-md-4">
                                {{ this.allcasepopuler.judul }}
                                <div class="text-isi-case-popular">
                                   {{ this.allcasepopuler.isi }}
                                </div>
...
//     }
    ...
    export default {
        ...
        mounted() {
            // let itemss = [];
            axios.get(process.env.MIX_API_URL+'user/getAllCasestudy')
            .then(data=>{
            ...
            axios.get(process.env.MIX_API_URL+'user/getAllCasestudyPopuler')
            .then(({ data }) => {
                this.allcasepopuler = data.articles;
            });
